...
type collectionLoader interface {
	Load(ctx context.Context, logger *slog.Logger, spec *ebpf.CollectionSpec, opts *bpf.CollectionOptions, lnc *datapath.LocalNodeConfiguration, attachmentContext *datapathplugins.AttachmentContext, pinsDir string) (*ebpf.Collection, func() error, func(), error)
}
...
func Enable(ctx context.Context, logger *slog.Logger, reg *registry.MapRegistry,
	collLoader collectionLoader, sysctl sysctl.Sysctl, lnc *datapath.LocalNodeConfiguration) error {
