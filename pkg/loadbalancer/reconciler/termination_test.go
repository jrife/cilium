...
func TestPrivilegedSocketTermination_Datapath(t *testing.T) {
	...
	lbmap.UpdateSockMeta(uint64(cookie), net.IP{127, 0, 0, 1}, 30000, 0)
	...
	lbmap.UpdateSockMeta(uint64(cookie3), net.IP{127, 0, 0, 1}, 30001, 0)
	l4a = loadbalancer.NewL3n4Addr(loadbalancer.UDP, cmtypes.AddrClusterFrom(ip, 0), 30001, 0)
	...
	assert.NoError(t, err)
	lbmap.UpdateSockMeta(uint64(getCookie(nil, 30004)), net.IP{127, 0, 0, 1}, 30004, 0)
	...
	lbmap.UpdateSockMeta(uint64(cookie3), net.IP{127, 0, 0, 1}, 30003, 0)
