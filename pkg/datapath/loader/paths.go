...
func bpffsDevicePluginPinsDir(base string, device netlink.Link, kind string) string {
	return filepath.Join(bpffsDeviceDir(base, device), "plugin_pins", kind)
}

func bpffsDevicePluginPinsTcDir(base string, device netlink.Link) string {
	return filepath.Join(bpffsDeviceDir(base, device), "plugin_pins", "tc")
}

func bpffsDevicePluginPinsXdpDir(base string, device netlink.Link) string {
	return filepath.Join(bpffsDeviceDir(base, device), "plugin_pins", "xdp")
}
...
func bpffsEndpointPluginPinsDir(base string, ep datapath.Endpoint) string {
