...
| pod_name | [string](#string) |  | pod name. |
...
| config | [google.protobuf.Any](#google-protobuf-Any) |  | config is one of the configuration structs defined at github.com/cilium/cilium/pkg/datapath/config/latest. Its type will match the attachment context. |
