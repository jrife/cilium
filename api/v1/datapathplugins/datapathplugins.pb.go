...
func (x *AttachmentContext_PodInfo) GetPodName() string {
	if x != nil {
		return x.PodName
	}
	return ""
...
const file_datapathplugins_datapathplugins_proto_rawDesc = "" +
	"\n" +
	"%datapathplugins/datapathplugins.proto\x12\x0fdatapathplugins\x1a\x19google/protobuf/any.proto\"\xa8\b\n" +
